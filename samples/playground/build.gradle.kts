...
compose.desktop {
    application {
        mainClass = "org.jetbrains.jewel.samples.playground.MainKt"

        nativeDistributions {
            targetFormats(TargetFormat.Dmg)
            packageName = "Jewel Playground"
            packageVersion = "1.0"
            description = "Jewel Playground"
            vendor = "Ivan Morgillo"
            licenseFile = rootProject.file("LICENSE")

            macOS {
                dockName = "Jewel Playground"
                bundleID = "com.ivanmorgillo.jewel.playground"
